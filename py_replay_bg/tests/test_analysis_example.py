...
def test_replay_bg():
    ...
    with open(os.path.join(workspace_folder, 'results', 'workspaces', 'data_day_1_replay_mcmc.pkl'), 'rb') as file:
    ...
    with open(os.path.join(workspace_folder, 'results', 'workspaces', 'data_day_1_replay_map.pkl'), 'rb') as file:
        replay_results = pickle.load(file)
