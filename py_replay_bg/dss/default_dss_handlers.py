...
def no_ip_handler(
    ...
    """
    Implements the default forcing insulin plasma input controller: "no forcing ip". Output must be in U/min.
    ...
    time: np.ndarray
        ...
        to time_index. The values after time_index should be ignored.
    forcing_ip: np.ndarray
        An array vector as long the simulation length containing all the forcing_ip (U/min) up to time_index.
        The values after time_index should be ignored.
    time_index: int
        The index corresponding to the previous simulation step of the replay simulation.
    dss: DSS
...
def no_ra_handler(
        ...
        basal: np.ndarray,
        time: np.ndarray,
        forcing_ra: np.ndarray,
        time_index: int,
        dss: object
        ) -> tuple[float, object]:
    """
    Implements the default forcing glucose plasma input controller: "no forcing ra". Output must be in mg/kg/min.
    ...
    time: np.ndarray
        ...
        to time_index. The values after time_index should be ignored.
    forcing_ra: np.ndarray
        An array vector as long the simulation length containing all the forcing_ra (mg/kg/min) up to time_index.
        The values after time_index should be ignored.
    time_index: int
        The index corresponding to the previous simulation step of the replay simulation.
    dss: DSS
