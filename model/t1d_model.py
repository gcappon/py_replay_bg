...
class T1DModel:
        ...
        if is_replay:
            ...
            for k in np.arange(1, self.tsteps):
                ...
                if self.is_single_meal:
                    ...
                    self.x[:, k] = self.__model_step_equations_multi_meal(self.A, bolus_delayed[k - 1] + basal_delayed[k - 1],
            ...
            if self.is_single_meal:
                ...
                for k in np.arange(1, self.tsteps):
                    # Integration step
                    self.x[:, k] = self.__model_step_equations_single_meal(self.A, bolus_delayed[k - 1] + basal_delayed[k - 1],
    ...
    @staticmethod
    @njit
    def __model_step_equations_single_meal(A, I, CHO, hour_of_the_day, xkm1, B, r1, r2, kgri, kd, p2, SI, VI, VG, Ipb, SG, Gb, f, kabs, alpha):
        """
